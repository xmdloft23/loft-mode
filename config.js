...
module.exports = {
    ...
    DATABASE_URL: process.env.DATABASE_URL || "DATABASE_URL: process.env.DATABASE_URL || "MONGODB_URI=mongodb+srv://mickidadyhamza_db_user:U41ddz44QsMxBI7D@cluster0.motlmco.mongodb.net/?appName=Cluster0", // Your Db URL here(optional). Can either be mongodb or postreSQL
